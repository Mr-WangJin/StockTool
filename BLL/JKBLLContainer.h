...
public:
	...
	template<typename BLLType>
	inline void save(const JKRef_Ptr<BLLType> &  refBLLObject);

	template<typename BLLType>
	inline void save(bean_ptr<ModelType> ptrModel);

	template<typename BLLType>
	inline void destroy(const JKRef_Ptr<BLLType> &  refBLLObject);
...
template<typename ModelType>
template<typename BLLType>
inline void JKBLLContainer<ModelType>::add(const JKRef_Ptr<BLLType> & refBLLObject)
{
...
template<typename ModelType>
template<typename BLLType>
inline void JKBLLContainer<ModelType>::save(const JKRef_Ptr<BLLType> &  refBLLObject)
{
...
template<typename ModelType>
template<typename BLLType>
inline void JKBLLContainer<ModelType>::destroy(const JKRef_Ptr<BLLType> &  refBLLObject)
{
	assert(mapBLLObject.find(refBLLObject->getOriginID()) != mapBLLObject.end());
	if (mapBLLObject.find(refBLLObject->getOriginID()) != mapBLLObject.end())
	{
